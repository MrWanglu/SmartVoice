package cn.fintecher.core.util;
...
public final class Constants {
    ...
    //通讯录导入excel模版url
    public static final String ADDRESS_BOOK_TEMPLATE_URL_CODE = "SysParm.addressbooktemplateurl";
    public static final String ADDRESS_BOOK_TEMPLATE_URL_TYPE = "9001";
