...
public final class Constants {
    ...
    //数据来源
    public static final String DATA_SOURCE = "0";//EXCEL 导入

    //通过文件ID获取文件对象的地址
    public static final String FILEID_SERVICE_URL = "http://file-service/api/";
    //通过TOKEN获取用户对象
    public static final String USERTOKEN_SERVICE_URL = "http://bussines-service/api/userResource/getUserByToken?token=";
