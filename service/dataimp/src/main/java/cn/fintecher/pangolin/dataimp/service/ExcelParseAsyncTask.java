 ...
 */
@Component
public class ExcelParseAsyncTask {

    private final Logger logger = LoggerFactory.getLogger(ExcelParseAsyncTask.class);
    ...
    public void parseRowDataExcel(int startRow, int rowTotal, int startCol, Sheet sheet, Class<?> dataClass,
                                  ...
                                  int rowNullNum, List<TemplateExcelInfo> templateExcelInfos) {
